...
-- Dumping database structure for absen_smk6
CREATE DATABASE IF NOT EXISTS `absen_smk6` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `absen_smk6`;
...
-- Dumping data for table absen_smk6.absensi: ~20 rows (approximately)
